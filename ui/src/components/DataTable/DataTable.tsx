...
const variantStyles = {
  default: {
    ...
    th: "text-left px-2 py-1 font-semibold text-gray-600 whitespace-nowrap",
  ...
  ghost: {
    container: "",
    thead: "bg-[#fdfdfd]",
    th: "text-left px-2 py-1 font-semibold text-gray-500 text-xs whitespace-nowrap",
    tr: "hover:bg-gray-50",
    td: "px-2 py-1 text-xs whitespace-nowrap",
  },
};
